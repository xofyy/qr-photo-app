  ...
  const getStatusInfo = () => {
    if (connectionType === 'websocket') {
      return {
        ...
        title: 'WebSocket connection active - real-time notifications'
      };
      ...
      return {
        ...
        title: 'Polling mode active - checking for updates every 10 seconds'
      };
    } else {
      return {
        icon: (
        ...
        title: 'No connection - notifications unavailable'
      };
    }
  };
