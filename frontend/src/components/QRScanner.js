...
const QRScannerComponent = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-blue-50 to-indigo-100 dark:bg-dark-gradient z-50 overflow-y-auto">
      <div className="min-h-full flex items-center justify-center p-2 sm:p-4 md:p-6 lg:p-8">
        
        {error ? (
          /* Error State */
          <div className="bg-white/90 dark:bg-dark-800/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 max-w-sm sm:max-w-md md:max-w-lg w-full text-center shadow-2xl my-2 sm:my-4 border border-gray-200/50 dark:border-dark-600/30">
            <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-red-100 dark:bg-red-900/30 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
              <svg className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          /* Success State */
          <div className="bg-white/90 dark:bg-dark-800/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 max-w-sm sm:max-w-md md:max-w-lg w-full text-center shadow-2xl my-2 sm:my-4 border border-gray-200/50 dark:border-dark-600/30">
            <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-green-100 dark:bg-green-900/30 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
              <svg className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white/90 dark:bg-dark-800/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl w-full shadow-2xl my-2 sm:my-4 border border-gray-200/50 dark:border-dark-600/30">
            ...
            {/* Camera Viewport */}
            <div className="relative bg-black dark:bg-dark-900 rounded-xl sm:rounded-2xl overflow-hidden mb-4 sm:mb-6" style={{ aspectRatio: '4/3' }}>
              <video 
                ref={videoRef}
              ...
              {/* Scanning overlay */}
              <div className="absolute inset-0 border-2 border-blue-500 dark:border-blue-400 rounded-xl sm:rounded-2xl opacity-50"></div>
              
              {/* Corner guidelines */}
              <div className="absolute top-4 left-4 w-8 h-8 border-t-4 border-l-4 border-blue-500 dark:border-blue-400 rounded-tl-lg"></div>
              <div className="absolute top-4 right-4 w-8 h-8 border-t-4 border-r-4 border-blue-500 dark:border-blue-400 rounded-tr-lg"></div>
              <div className="absolute bottom-4 left-4 w-8 h-8 border-b-4 border-l-4 border-blue-500 dark:border-blue-400 rounded-bl-lg"></div>
              <div className="absolute bottom-4 right-4 w-8 h-8 border-b-4 border-r-4 border-blue-500 dark:border-blue-400 rounded-br-lg"></div>
            ...
            {/* Instructions */}
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700/30 rounded-xl p-4 mb-6">
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-500 dark:bg-blue-400 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
