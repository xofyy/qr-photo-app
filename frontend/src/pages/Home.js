    ...
    <Layout>
      <div className="w-full max-w-6xl mx-auto px-3 sm:px-4 py-6 sm:py-8 lg:py-12">
        ...
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-4 sm:mb-6 px-2">
            Share Moments
            <br />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12 max-w-4xl mx-auto">
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white/50 rounded-xl sm:rounded-2xl backdrop-blur-sm border border-gray-200/50">
              ...
              <p className="text-gray-600 text-sm text-center">Instant QR codes for easy access</p>
            </div>

            <div className="flex flex-col items-center p-6 bg-white/50 rounded-2xl backdrop-blur-sm border border-gray-200/50">
              ...
              <p className="text-gray-600 text-sm text-center">Direct camera access on any device</p>
            </div>
            ...
            <div className="flex flex-col items-center p-6 bg-white/50 rounded-2xl backdrop-blur-sm border border-gray-200/50">
              ...
              <p className="text-gray-600 text-sm text-center">Automatic cloud backup & sharing</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-xl border border-gray-200/50 p-8 text-center">
              ...
              <p className="text-gray-600 mb-8">Create QR codes for your guests to share photos from weddings, parties, corporate events, and more.</p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center text-left">
                  ...
                  <span className="text-gray-700">Create unlimited photo sessions</span>
                </div>
                <div className="flex items-center text-left">
                  <svg className="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700">Manage and download all photos</span>
                </div>
                <div className="flex items-center text-left">
                  <svg className="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700">Generate custom QR codes</span>
                </div>
              </div>
              ...
              {isAuthenticated ? (
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 px-6 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center space-x-3"
                >
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-xl border border-gray-200/50 p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Have a QR Code?</h3>
              <p className="text-gray-600 mb-8">Already received a QR code from an event organizer? Scan it to start uploading photos instantly - no account needed!</p>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center text-left">
                  ...
                  <span className="text-gray-700">Upload photos instantly</span>
                </div>
                <div className="flex items-center text-left">
                  <svg className="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700">Share memories with everyone</span>
                </div>
              </div>
        ...
        {qrCode && (
          <div className="max-w-2xl mx-auto mt-8 animate-fade-in">
            <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-gray-200/50 p-8 sm:p-12">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Share this QR code with your guests to start collecting photos</p>
              </div>
              
              <div className="flex flex-col items-center">
                {/* QR Code */}
                <div className="bg-white p-6 rounded-2xl shadow-lg mb-6 transform hover:scale-105 transition-transform duration-300">
                  <img 
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8 w-full max-w-md">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center space-x-2 bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-105"
                  >
                  ...
                  <button
                    onClick={downloadQR}
                    className="flex-1 flex items-center justify-center space-x-2 bg-blue-100 hover:bg-blue-200 text-blue-800 font-semibold py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-105"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="mt-4 text-blue-600 hover:text-blue-800 font-medium flex items-center space-x-1 transition-colors duration-200"
                >
